mbus is an Android client for the University of Michigan's Magic Bus system: http://mbus.pts.umich.edu/
...
I own a Moto Cliq, which as of this writing runs Android 1.5. Doesn't look like Motorola is going to update to 1.6 anytime soon, so I want to be able to use it myself. Hopefully, other handset users won't be hit too hard by the varying screen sizes.
